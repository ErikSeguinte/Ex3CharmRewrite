...
\begin{Ability}{Craft}
  ...
  \begin{itemize}
    \item 4 dot artifacts can be rolled once per session
    \item 5 dot artifacts can be rolled once every other session.
    \item Greater Manses can be rolled once every 3 session.
