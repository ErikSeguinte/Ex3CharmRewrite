...
% Produces Rating dots without writing out the commands.
\newcounter{x}
\newcommand{\rating}[1]{
...
\IfFileExists{Ex3Final.pdf}{}{
  \begin{bgPic}{resources/Traits-left.jpg}{resources/Traits-right.jpg}
	...
	\begin{tabular}{ll}
	  ...
	  \hline
	  \textbullet{}\textbullet & 100xp\\
	  \textbullet{}\textbullet{}\textbullet{} & 175xp\\
	  \textbullet\textbullet\textbullet\textbullet & 250xp\\
	  \textbullet\textbullet\textbullet\textbullet\textbullet & 350xp\\
	\end{tabular}
      \end{multicols}
    \end{bgPic}
    ...
    %\pgs{225}{239}
    \pdfbookmark[1]{Crime and Investigation}{Crime and Investigation}
    \pgs{225}{226}
    \pdfbookmark[1]{Leadership}{Leadership}
    \pgs{227}{229}
    \pdfbookmark[1]{Environmental And Feats}{Environmental and Feats}
    \pgs{230}{239}
    \clearpage
	...
	\begin{sidebar}{Large Scale Projects}

	  \par
	  Multiple related projects can be abstracted into a single large project.
	  Instead of a thousand small projects to equip a legion,
	  a Crafter can instead use a single Large Project.
	  Large projects may include a mansion, creating the furniture for a mansion, or building a ship.
	  Large Projects have the unique component of Scale, an abstraction of size and complexity and is analogous to an artifact's rating.
	  Large Projects require unskilled (Scale) labor and (Scale-1) skilled labor.
	  The Crafter rolls normally, modeling his ability to supervise and manifest his vision.
	  If using the story based intervals  the manifestation of the project still requires the listed interval.
	  For Gameplay purposes, the project is complete and will appear in the narrative during the next appropriate downtime.

	  \centering
	  \label{my-label}
	  \begin{tabular}{@{}lllllp{2.75in}@{}}
	    \toprule
	    Scale & Interval & Labor         & Diff & Goal\# & Examples                                                                              \\ \midrule
	    1     & Day      & A handful     & 2          & 25     & A sturdy hut, a dingy, equip a Fang.                                                  \\
	    2     & Week     & A dozen or so & 3          & 30     & A spacious house, several sturdy huts, a sailboat, equip a Scale.                     \\
	    3     & Season   & Several dozen & 4          & 40     & A sprawling compound or mansion, a warship, equip a Wing.  \\
	    4     & Year     & hundreds      & 5          & 50     & An Emperor’s palace, a small fleet of warships, a great trade galley, equip a Dragon. \\
	    5     & Years    & Thousands     & 5          & 75     & A mid-sized city, a frightening war or trade fleet, equip a Legion.                   \\
	    N/A   & ???      & ???           & ???        & ???    & The Imperial Palace, the White Sea Dam, Whitewall                                     \\ \bottomrule
	  \end{tabular}

	  A Crafter may decrease the Interval period by one level by increasing labor by one level.
	\end{sidebar}
	...
	\begin{tabular}{ccccc}
	  ...
	  \hline
	  \textbullet\textbullet & 3 & Two Weeks & 25 \\
	  \textbullet\textbullet\textbullet & 4 & One Month & 30 \\
	  Manse & 4 & One Month & 30\\
	  \textbullet\textbullet\textbullet\textbullet & 5 & Two Months & 40 \\
	  \textbullet\textbullet\textbullet\textbullet\textbullet & 5 & One Season & 50 \\
	...
	\begin{tabular}{@{}ll@{}}
	\toprule
	Artifact\slash{}Scale & Alternate Story-based Interval \\
	  \midrule
	  \textbullet\textbullet & Twice per Session \\
	  \textbullet\textbullet\textbullet & Once per Session \\
	  Manse & Once per Session \\
	  \textbullet\textbullet\textbullet\textbullet & Twice per Story \\
	  \textbullet\textbullet\textbullet\textbullet\textbullet & Once per Story \\
